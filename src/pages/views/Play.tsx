...
interface PlayComponentProps extends ModelState {
  onPress: () => void;
}

class Play extends React.Component<PlayComponentProps> {
  animation = new Animated.Value(0);
  rotate: Animated.AnimatedInterpolation;
  timing: Animated.CompositeAnimation;
  constructor(props: PlayComponentProps) {
    super(props);
        ...
        <Progress>
          <Animated.View style={{transform: [{rotate: this.rotate}]}}>
            {thumbnailUrl ? (
              ...
              <IconFont name="play" color="#ededed" size={40} />
            )}
          </Animated.View>
        </Progress>
      </Touchable>
