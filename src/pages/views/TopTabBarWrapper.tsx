...
type TobTabBarWrapperProps = MaterialTopTabBarProps & ModelState;

class TobTabBarWrapper extends React.Component<TobTabBarWrapperProps> {
  goCategory = () => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottom}>
          <Touchable style={styles.searchBtn}>
            <Text style={textStyle}>Seach</Text>
          </Touchable>
...
export default connector(TobTabBarWrapper);
